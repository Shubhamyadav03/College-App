...
import com.example.collegeapp1.NoticeData;
import com.example.collegeapp1.R;
import com.example.collegeapp1.UploadNotice;
...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items = new String[]{"Select Category", "Computer Science", "Mechanical", "Electronic", "Electrical"};
