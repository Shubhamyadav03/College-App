package com.example.collegeusersapp.ui.faculty;
...
public class FacultyFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        electroDepartment = view.findViewById(R.id.electroDepartment);

        elecNodata = view.findViewById(R.id.elecNodata);
        mechNodata = view.findViewById(R.id.mechNodata);
        csNodata = view.findViewById(R.id.csNodata);
        electroNodata = view.findViewById(R.id.electroNodata);
        ...
        dbRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    electroDepartment.setLayoutManager(new LinearLayoutManager(getContext()));
